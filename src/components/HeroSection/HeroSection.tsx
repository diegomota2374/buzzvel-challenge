    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Hi, I&apos;m Front-end Development Analyst with expertise in
            JavaScript, TypeScript, React, and Node.js. I focus on delivering
            efficient, high-quality results and continuously improving my
            skills.
          </p>
        </div>
      </section>
