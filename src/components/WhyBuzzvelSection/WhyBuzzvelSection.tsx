...
const WhyBuzzvel = () => {
  ...
  return (
    <>
      ...
      <NextSeo
        title="Why Buzzvel?"
        description="Discover why Diego Mota Cavalcante is excited about the opportunity to join Buzzvel, focusing on innovation, customer-centric approaches, and dedicated expertise."
        openGraph={{
          title: "Why Buzzvel?",
          description:
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                inspiring. I am excited about the opportunity to be part of a
                team dedicated to delivering products that drive client success
                and growth.
              </p>
            </motion.div>
          </div>
